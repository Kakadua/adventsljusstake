...
void handleHttpRequest(WiFiClient client, String request) {
  ...
  if (requestPath.equals("/")) {
    ...
    body += "  xhr.onreadystatechange = function() {\r\n";
    body += "    if (this.readyState == 4) {\r\n";
    body += "       setStatusMessage(this.responseText);\r\n";
    body += "    }\r\n";
    body += "  };\r\n";
    body += "  xhr.open('GET', path);\r\n";
    body += "  xhr.timeout = " + String(xhr_timeout_ms) + ";\r\n";
    body += "  xhr.ontimeout = function () {setStatusMessage('Error: Timeout')};\r\n";
    body += "  xhr.send();\r\n";
    body += "}\r\n\r\n";
